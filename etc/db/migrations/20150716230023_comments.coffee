exports.up = (knex, Promise) ->
  knex.schema.createTable "comments", (table) ->
    ...
    table.string("short_id", 10).unique().index().notNull().defaultTo ""
    ...
    table.integer("thread").index().notNull()#.references("id").inTable "comment_threads"
    table.integer("parent").notNull().references("id").inTable "comments"
