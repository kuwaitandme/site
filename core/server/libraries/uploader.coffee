...
###
  ...
  String filename      The filename for the given file.
...
###
  ...
  String filepath       A path to the image file to which the most dominant color has to be read.
  filepath

  String                A hex representation of the most dominant color.
...
###
  ...
  String filename      The filename which is to given a unique name
  filename

  String               A string that contains the same extension as the original fiqle but contains a unique id.
...
* now.
*
* ile file        The file object which is to be validated
*
* Boolean         Returns True iff the file is good to be uploaded.
*
...
exports = module.exports = (settings) ->
  ...
  rray tasks                The tasks that have been set from theupload function. Each task should be anobject containing a newPath, oldPath and newFilename key.

  Promise                   A promise that resolves once the images have been uploaded and the thumbnails have been created.
  ###
  ...
  rray tasks         An array of tasks that was passed to the operate function.

  Promise            A promise that resolves iff the thumbnails could be created.
  ###
  ...
  new class Uploader
    ...
    rray files       An array of file object that have to uploaded.
    bject options    Options that get used during the file upload.

    Promise          Returns a promise that resolves with an array of successfully uploaded files (with the dominant color and new/old file paths).
    ###
    ...
    rray files            An array of files that need to be deleted. Each array item follows the same object hierarchy as the ones that passed in the operate function.

    Promise               A promise that resolves iff the files were successfully deleted.
    ###
