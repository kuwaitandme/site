...
db.categories.insert([
	...
	{ name:'Community', children: [
		...
		{ _id: ObjectId(), name:'Elderly Assistance' },
		...
		{ _id: ObjectId(), name:'Rideshare' },
		{ _id: ObjectId(), name:'Skills Swap' },
		{ _id: ObjectId(), name:'Other' }
	]},
	...
	{ name:'Classes', children: [
		...
		{ _id: ObjectId(), name:'Computer' },
		{ _id: ObjectId(), name:'Education' },
		{ _id: ObjectId(), name:'Language' },
		{ _id: ObjectId(), name:'Sports Wellness' },
	...
	{ name:'Jobs', children: [
		...
		{ _id: ObjectId(), name:'Customer Service' },
		...
		{ _id: ObjectId(), name:'Part Time' },
		{ _id: ObjectId(), name:'Public Service' },
	...
	{ name:'Personal', children: [
		...
		{ _id: ObjectId(), name:'Activity Partners' },
		{ _id: ObjectId(), name:'Language Exchange' },
		{ _id: ObjectId(), name:'Other' }
	]}
]);
