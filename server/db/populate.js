...
db.categories.insert([{
	...
	name: 'Electronics',
	children: [
		{ _id: ObjectId(), name: 'Mobile/Tablets' },
		{ _id: ObjectId(), name: 'Computers/Laptops' },
		{ _id: ObjectId(), name: 'Accessories' },
		{ _id: ObjectId(), name: 'TV/DVD/Multimedia' },
		{ _id: ObjectId(), name: 'Home/Kitchen' },
		{ _id: ObjectId(), name: 'Other' }
	]
}, {
	name: 'Classes',
	...
	name: 'Miscellaneous',
	children: [
		{ _id: ObjectId(), name: 'Miscellaneous' }
	]
}]);
